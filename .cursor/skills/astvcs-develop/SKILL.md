...
- If CLI behavior changed, update [docs/commands.md](../../../docs/commands.md) and add or extend a test in `tests/integration.rs`.
- If merge or diff semantics changed, update the matching fixture under `examples/` and its row in [examples/README.md](../../../examples/README.md).
