...
| `complex_struct_field_and_body_disjoint_merge_roundtrip` | Struct field insert + function body edits on separate branches merge without hang (unit, `merge/mod.rs`) |
